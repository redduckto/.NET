...
{
    class AASpor : SuperClass
    {
        public AASpor(MainForm form, Kategoriler kategoriForm)
        {
            URL = "http://aa.com.tr/tr/spor";
            ...
            IlkYükleme = false;
            XMLilkYükleme = false;
            PanelBaşlığı = "AA/Spor";
            XmlBaşlığı = "AASpor";
            CheckBox = kategoriForm.aaSporCheckBox;
        }
